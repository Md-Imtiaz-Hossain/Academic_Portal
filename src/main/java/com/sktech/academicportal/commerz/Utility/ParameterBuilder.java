...
public class ParameterBuilder {
    ...
    public static Map<String, String> constructRequestParameters() {
        ...
        postData.put("success_url", baseUrl + "data/pay-success");
        ...
        postData.put("cus_name", "Customer Name");
        ...
        postData.put("ipn_url", "https://xyzacademicportal.herokuapp.com/data/pay-success");
        return postData;
    }

    public static Map<String, String> constructRequestParam(String baseUrl, String payment, String transactionID, String studentID, String doctorID) {
        // CREATING LIST OF POST DATA
        ...
        postData.put("cancel_url", "https://sandbox.sslcommerz.com/developer/cancel.php");
        postData.put("version", "3.00");
        postData.put("cus_name", "Customer-ID: "+studentID);
        ...
        postData.put("cus_phone", "0111111111");
        postData.put("cus_fax", "0171111111");
        postData.put("ship_name", "Customer-ID: "+studentID);
        postData.put("ship_add1", "Address Line On");
        postData.put("ship_add2", "Address Line Tw");
        postData.put("ship_city", "City Nam");
        postData.put("ship_state", "State Nam");
