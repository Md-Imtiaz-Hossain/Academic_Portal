...
public class SubjectWithStudent {
    ...
    public String subjectOfStudent(@PathVariable Integer userId, @PathVariable Integer subjectId, Model model) {
    ...
    public String processSubjectForm(@PathVariable Integer userId,
    ...
    public String markListstudent(Model model) {
    ...
    @GetMapping("/edit/{id}")
    public String editStudentSubjectInfo(@PathVariable Integer id, Model model) {
    ...
    public String processUpdateForm(@PathVariable Integer id, @ModelAttribute("result") StudentResult result) {
